...
def get_ville
  ...
  ville_name_array = []
  page_url_region = URI.open"https://www.annuaire-des-mairies.com/val-d-oise.html"
...
def get_email (ville_names)
  ...
  for n in 0...ville_names.length
    ...
    page_url_ville = URI.open"https://www.annuaire-des-mairies.com/95/#{ville_names[n]}.html"
...
CSV.open(filepath, 'wb',csv_options)
