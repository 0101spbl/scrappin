...
def get_deputes_name
  ...
  page_url_deputes = URI.open"http://www2.assemblee-nationale.fr/deputes/liste/alphabetique"
...
def get_deputes_email (deputes_names)
  ...
  for n in 0...10
    ...
    page_url_deputes = URI.open"http://www2.assemblee-nationale.fr/#{deputes_names[n]}"
